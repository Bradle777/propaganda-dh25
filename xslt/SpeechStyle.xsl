...
<xsl:stylesheet 
    ...
    <xsl:param name="uiMode" select="'political'"/>
    ...
    <xsl:template match="speech">
        <html>
            <head>
                ...
                <style>
                   ...
                   padding-top: 0;
                    ...
                    body.anthro-mode span.label.political {
                    display: none;
                    }
                    
                    
                    body.anthro-mode span.label.anthro {
                    display: inline;
                    }
            ...
            <body>
                ...
                <div id="modeToggle">
                    <button onclick="toggleMode()">Anthro Mode</button>
                </div>
